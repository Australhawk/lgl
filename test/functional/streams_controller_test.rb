...
class StreamsControllerTest < ActionController::TestCase
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post :create, stream: { description: @stream.description, id: @stream.id, image: @stream.image, title: @stream.title }
    end
  ...
  test "should update stream" do
    put :update, id: @stream, stream: { description: @stream.description, id: @stream.id, image: @stream.image, title: @stream.title }
    assert_redirected_to stream_path(assigns(:stream))
  end
